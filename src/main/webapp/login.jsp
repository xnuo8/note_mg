        ...
        <div id="tabcon">
            <div class="box show">
                <form action="user" method="post" id="loginForm">
                    ...
                    <input type="text" class="user yahei16" id="userName" name="userName"
                           value="${resultInfo.result.uname}"/><br/><br/>
                    <input type="password" class="pwd yahei16" id="userPwd" name="userPwd"
                           value="${resultInfo.result.upwd}"/><br/><br/>
...
<div id="bottom">
    <div id="copyright">
        <div class="quick">
            <ul>
                <li><input type="button" class="quickbd iphone" onclick="location.href='http://baidu.com'"/></li>
                <li><input type="button" class="quickbd android" onclick="location.href='http://baidu.com'"/></li>
                <li><input type="button" class="quickbd pc" onclick="location.href='http://baidu.com'"/></li>
                <div class="clr"></div>
            </ul>
            <div class="clr"></div>
        </div>
